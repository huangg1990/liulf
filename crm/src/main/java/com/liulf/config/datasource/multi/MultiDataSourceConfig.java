...
@MapperScan(basePackages = {"com.liulf.liulf.modular.*.mapper"}, sqlSessionTemplateRef = "crmSqlSessionTemplate")
public class MultiDataSourceConfig {
     ...
     */
    @Bean
    @ConfigurationProperties(prefix = "liulf.muti-datasource")
