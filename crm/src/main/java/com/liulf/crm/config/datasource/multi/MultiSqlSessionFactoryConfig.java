 ...
 */
package com.liulf.crm.config.datasource.multi;
...
@Slf4j
@Configuration
@ConditionalOnProperty(prefix = "crm.muti-datasource", name = "open", havingValue = "true")
public class MultiSqlSessionFactoryConfig {

    /**
     * xml文件的位置，改包了注意修改哦
     */
    public static final String MAPPING_XML_CLASSPATH = "classpath:com.liulf.crm/modular/**/mapping/*.xml";
    ...
    public OptionalSqlSessionTemplate ybjSqlSessionTemplate(@Qualifier("sqlSessionFactoryPrimary") SqlSessionFactory sqlSessionFactoryPrimary,
