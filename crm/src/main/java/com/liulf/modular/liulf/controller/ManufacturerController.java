...
import com.liulf.modular.liulf.entity.Manufacturer;
import com.liulf.modular.liulf.entity.SysCity;
import com.liulf.modular.liulf.service.ManufacturerService;
...
public class ManufacturerController extends CRMBaseController {
    private final static String PREFIX = "/modular/liulf/manufacturer/";
